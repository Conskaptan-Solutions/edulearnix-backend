...
- `MONGO_URI` = mongodb+srv://mdmijanur:Mijanur12345@cluster0.q2zhngv.mongodb.net/jobkaptan?retryWrites=true&w=majority
- `JWT_SECRET` = jobkaptan_jwt_secret_key_2026_very_secure
- `PORT` = 5000
- `NODE_ENV` = production
- `CLIENT_URL` = https://your-frontend-domain.netlify.app
- `SUPER_ADMIN_NAME` = Md Mijanur Molla
- `SUPER_ADMIN_EMAIL` = mdmijanur.molla@nextkaptan.in
